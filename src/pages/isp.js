                ...
                <div className="container">
                    ...
                    <div className="row">
                        <div className="col-md-6">
                            ...
                            <p>Has an unplanned outage occured? Send a message to alert individual customers, groups of customers based on geo-location, position in the network, or any customer criteria.</p>
                            <br />
                        </div>
                        <div className="col-md-6">
                            <div className="isp-image text-center">
                    ...
                    <div className="row">
                        ...
                        <h6>Network Connection Testing</h6>
                            <p>The first thing a new customer typically does is run a speed test. However, speed tests are often unreliable as they don’t take the device, router or network capacity in to account.</p>
