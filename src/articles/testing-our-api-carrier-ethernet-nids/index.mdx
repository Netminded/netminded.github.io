...
exerpt: "Our newly created API and Python environment needed a test beyond meeting our own internal needs. Conveniently, just after we completed version one of our external feeds API, I was meeting friends in London who work at Accedian."
